...
author: 
  - Matt Crump
  - Shifa Maqsood
abstract: "This is a reproducible analysis script for Experiment 1C."
---
...
Finally, there was a main effect of block type, `r recall_apa_print$full_result$block_type`. Mean proportion recall was lower for the blocked (M = `r recall_effect_means$block_type[block_type == "blocked"]$mean_proportion_recalled`, SEM = `r recall_effect_means$block_type[block_type == "blocked"]$sem_proportion_recalled`), than mixed conditions (M = `r recall_effect_means$block_type[block_type == "mixed"]$mean_proportion_recalled`, SEM = `r recall_effect_means$block_type[block_type == "mixed"]$sem_proportion_recalled`).
